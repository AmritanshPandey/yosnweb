...
// Film-grain noise texture — gives a cinematic, premium feel.
// SVG feTurbulence is hardware-accelerated; fixed position keeps it out of the paint budget.
export function GrainOverlay() {
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none fixed inset-0 z-[9990] select-none"
      style={{
        opacity: 0.028,
